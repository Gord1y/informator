  ...
  return (
    <Section disableMaxWidth className='mt-5 max-w-screen-sm items-center'>
      <Heading className='text-center'>
        {step === 0 ? 'Authorization' : 'Verify your email'}
      </Heading>
      <p className='text-center font-semibold xl:text-lg'>
        {step === 0
          ...
          : 'Only one step left! Check your email to verify your account.'}
      </p>
      {step === 0 && (
        <section className='flex w-full max-w-screen-sm flex-col gap-1 md:gap-2'>
          ...
          {type === 'login' ? (
            ...
            >
              No account? <b className='text-primary'>Register</b>
            </Button>
          ) : (
            <Button
              variant={'ghost'}
            ...
            >
              Already have account? <b className='text-primary'>Login</b>
            </Button>
          )}
        </section>
      )}
